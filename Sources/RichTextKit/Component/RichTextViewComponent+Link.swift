...
/// TODO: Delete this when configuration PR is ready https://github.com/DominikBucher12/RichTextKit/pull/1
...
public extension RichTextViewComponent {
    ...
    func setCurrentRichTextLink(_ link: URL?) {
        ...
        if let link {
            applyToCurrentSelection(.richTextLink, to: CustomLinkAttributes(link: link.absoluteString, color: linkColor))
        } else {
